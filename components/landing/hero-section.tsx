...
const words = ["enthuse", "empower", "motivate"];
    ...
    <section id="home" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          ...
          >
            <span className="block">The step</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          ...
          >
            Empowering students, preparing professionals, and building confidence. Offering specialized courses for CA, CMA, CS, and Law, and transformative student mindset workshops.
          </p>
